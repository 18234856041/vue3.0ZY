...
export function ajax (params) {
  ...
  for (const item in params.data) {
    //  如果传过来没有值，默认为空
    if (params.data[item] === undefined || params.data[item] === null || params.data[item] === '') {
      params.data[item] = ''
    }
  ...
  if(params.type === 'post'){
    ...
    if (params.headers === undefined || params.headers === null || params.headers === '') {
      axios.defaults.headers.post['Content-Type'] = 'application/x-www-form-urlencoded'
    } else {
      axios.defaults.headers.post['Content-Type'] = params.headers
    }
    ...
    if (params.headers === undefined || params.headers === null || params.headers === '') {
      ...
      axios.defaults.headers.get['Content-Type'] = params.headers
    }
    data = params.data
  }
